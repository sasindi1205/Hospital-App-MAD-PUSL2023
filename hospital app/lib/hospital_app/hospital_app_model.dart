...
Widget wrapWithModel<T extends hospitalAppModel>({
  required T model,
...
T createModel<T extends hospitalAppModel>(
...
abstract class hospitalAppModel<W extends Widget> {
...
class hospitalAppDynamicModels<T extends hospitalAppModel> {
  hospitalAppDynamicModels(this.defaultBuilder);
