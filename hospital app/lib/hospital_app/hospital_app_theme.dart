...
abstract class hospitalAppTheme {
  ...
  static hospitalAppTheme of(BuildContext context) {
...
class LightModeTheme extends hospitalAppTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
...
class DarkModeTheme extends hospitalAppTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
