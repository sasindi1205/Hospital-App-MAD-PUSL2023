...
class hospitalAppIconButton extends StatefulWidget {
  const hospitalAppIconButton({
    super.key,
    required this.icon,
    this.borderColor,
    this.borderRadius,
  ...
  @override
  State<hospitalAppIconButton> createState() => _hospitalAppIconButtonState();
}

class _hospitalAppIconButtonState extends State<hospitalAppIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(hospitalAppIconButton oldWidget) {
