...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _hospitalAppButtonTabBarState tabBar;
...
/// A hospitalApp Design widget that displays a horizontal row of tabs.
class hospitalAppButtonTabBar extends StatefulWidget
  ...
  /// and the entire [hospitalAppButtonTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  @override
  State<hospitalAppButtonTabBar> createState() =>
      _hospitalAppButtonTabBarState();
}

class _hospitalAppButtonTabBarState extends State<hospitalAppButtonTabBar>
  ...
  @override
  void didUpdateWidget(hospitalAppButtonTabBar oldWidget) {
